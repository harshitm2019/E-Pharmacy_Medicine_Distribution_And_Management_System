...
@Operation(summary = "Get Batches By Medicine", description = "Returns a paginated list of batches for a specific medicine.")
@ApiResponses({
...
public @interface GetBatchesByMedicineApi {
}
