...
@Operation(summary = "Get Batch By ID", description = "Returns a batch by its ID.")
@ApiResponses({
        @ApiResponse(responseCode = SwaggerResponses.OK, description = SuccessMessages.BATCH_FETCHED),
...
public @interface GetBatchByIdApi {
}
