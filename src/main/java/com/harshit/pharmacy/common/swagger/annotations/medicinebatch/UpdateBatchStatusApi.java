...
@Operation(summary = "Update Batch Status", description = "Updates the status of one or more batches.")
@ApiResponses({
        @ApiResponse(responseCode = SwaggerResponses.OK, description = SuccessMessages.BATCH_STATUS_UPDATED),
        ...
        @ApiResponse(responseCode = SwaggerResponses.NOT_FOUND, description = "One or more batches not found")
})
@SecurityRequirement(name = SwaggerConstants.BEARER_AUTH)
public @interface UpdateBatchStatusApi {
}
