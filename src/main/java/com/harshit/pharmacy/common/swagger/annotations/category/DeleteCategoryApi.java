...
@ApiResponses({
        @ApiResponse(responseCode = SwaggerResponses.OK, description = SuccessMessages.CATEGORY_DELETED),
        ...
        @ApiResponse(responseCode = SwaggerResponses.CONFLICT, description = "Category is associated with medicines")
})
