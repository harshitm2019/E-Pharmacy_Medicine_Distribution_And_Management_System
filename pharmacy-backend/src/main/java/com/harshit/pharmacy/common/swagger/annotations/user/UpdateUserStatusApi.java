...
@Operation(
        ...
        description = "Activates or deactivates a user account. Accessible only by ADMIN."
)
@ApiResponses({
        @ApiResponse(responseCode = SwaggerResponses.OK, description = SuccessMessages.USER_STATUS_UPDATED),
        ...
        @ApiResponse(responseCode = SwaggerResponses.NOT_FOUND, description = ErrorMessages.USER_DOES_NOT_EXIST)
})
@SecurityRequirement(name = SwaggerConstants.BEARER_AUTH)
public @interface UpdateUserStatusApi {
}